...
sessions.push({ pid: 110, start_time: 12, kind: 'codex', host: 'Codex app', project: '/fixture/current', session_name: 'Current work', state: 'active', rss: 1024*MB, cpu: 6, age_secs: 10000, idle_secs: 10, pids: [110], ports: [], engine: true,
  threads: [
    {id:'current', name:'Add deeper Codex task visibility', cwd:'/fixture/autoTrim', last_activity:epoch-10, transcript:'/fixture/current.jsonl'},
